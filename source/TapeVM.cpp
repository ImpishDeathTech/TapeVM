...
namespace tape {
      ...
      
  {
    ...
    m_includeDirectories = {
      ...
      "/usr/share/tapevm/libraries/?.4th",
      "/usr/share/tapevm/libraries/?.fs",
      "/usr/share/tapevm/libraries/?.f",
      "./tape/?.tape",
      "./tape/?.fth",
      "./tape/?.4th",
      "./tape/?.fs",
    ...
    m_includeDirectories = { 
      ...
      "C:\\ProgramFiles\\TapeVM\\tape\\?.4th",
      "C:\\ProgramFiles\\TapeVM\\tape\\?.fs",
      "C:\\ProgramFiles\\TapeVM\\tape\\?.f",
      ".\\tape\\?.tape",
      ".\\tape\\?.fth",
      ".\\tape\\?.4th",
      ".\\tape\\?.fs",
